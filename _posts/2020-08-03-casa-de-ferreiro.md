...
<figure class="side">
  <img alt="Scan de página da revista 'Almansor: Revista de Cultura', primeira
  edição de 2002 (2ª série). O texto diz: 'Em casa de ferreiro, espeto de
  salgueiro: uma abordagem ao ofício de ferreiro. De Maria do Rosário Caeiro.'"
...
Comecei minha pesquisa utilizando a <a href="http://memoria.bn.br/">Biblioteca
Nacional Digital</a> brasileira. É um recurso incrível que permite a busca por
palavras em centenas de páginas de jornais de diversas épocas e locais.

A referência mais antiga que eu encontrei nessa ferramenta foi na edição de 7 de
novembro de 1834 do <a
href="https://pt.wikipedia.org/wiki/Jornal_do_Commercio">Jornal do
Commercio</a>, em que uma coluna de autoria de "*Carapuceiro*" possui o ditado
<strong><q>Em casa de ferreiro, espeto de pau</q></strong>:

<figure class="top">
  <img alt="Cabeçalho do 'Jornal do Commercio', edição de 7 de novembro
 de 1834."
   src="/assets/img/2020-08-03/commercio-1.jpg">
</figure>
...
Fora da Biblioteca Nacional, encontrei duas referência em "<a
href="https://books.google.com.br/?id=lttWAAAAcAAJ">Collecção de Proverbios,
Adagios, Rifãos, Anexins, Sentenças Moraes e Idiotismos da Lingoa Portugueza</a>"
(<a href="https://pt.wikipedia.org/wiki/Rio_de_Janeiro">Rio de Janeiro</a>,
1848; pp. 36, 67), por P. Perestrello da Camara. A versão listada também é
<strong><q>Em casa de ferreiro, espeto de pau</q></strong>.
...
Como descrito em "<a href="https://www.uniritter.edu.br/files/sepesq/arquivos-trabalhos-2019-2/4-lilia-baranski-feres-a-chegada-dos-livros-no-brasil.pdf">A
chegada dos livros no Brasil</a>" (<a
href="https://pt.wikipedia.org/wiki/Porto_Alegre">Porto Alegre</a>, 2018),
pós-graduação de **Lilia Baranski Feres** na UniRitter, a imprensa no Brasil só
foi permitida a partir de 1808, com a vinda da família real à colônia.

Antes disso, livros escritos eram enviados para Portugal para serem impressos lá,
...
<figure class="side">
  <img alt="Citação do Correio Braziliense, de junho de 1808: 'Saiba pois o
mundo, e a posteridade, que no ano de 1808, da era Cristã, mandou o Governo
Português, no Brasil, buscar na Inglaterra uma Impressão, com os seus
apendículos necessários; e a remessa que daqui se lhe fez importou em CEM LIBRAS
ESTERLINAS! [...] Tarde; desgraçadamente tarde. Mas enfim aparecem tipos no
Brasil; e eu de todo o meu coração dou os parabéns aos meus compatriotas
Brazilienses.'"
   src="/assets/img/2020-08-03/correio-braziliense.png">
  <figcaption>
    <em>
...
Fui em toda essa tangente enorme para dizer que, se existe ocorrência do ditado
...
<figure class="top">
  <img alt="Scan de parte do cabeçalho do 'Diccionario da Lingua Portugueza', de
 1789."
...
<figure class="bottom side">
  <img alt="Trecho do 'Diccionario da Lingua Portugueza' que, além de outras
 coisas, cita a expressão 'Em casa de ferreiro, pior apeiro'."
...
<figure class="top">
  <img alt="Scan de parte do cabeçalho do 'Adagios Portuguezes', de 1651."
   src="/assets/img/2020-08-03/adagios-portvgvezes-1.png"
   style="max-height:10rem">
</figure>

<figure class="bottom side">
  <img alt="Trecho do 'Adagios Portuguezes' que, além de outras coisas, utiliza
 a expressão 'Em casa de ferreiro, pior apeiro'."
...
<figure class="top">
  <img alt="Cabeçalho da capa do dicionário castelhano de 1729."
   src="/assets/img/2020-08-03/diccionario-castellana-1.png"
   style="max-height:15rem">
</figure>

<figure class="bottom side">
  <img alt="Trecho do dicionário que lista as três variantes da expressão."
...
<figure class="top">
  <img alt="Cabeçalho da capa do 'Tesoro da Lengua Castellana', de 1611."
   src="/assets/img/2020-08-03/tesoro-castellana-1.png">
</figure>
<figure class="bottom side">
  <img alt="Trecho do 'Tesoro da Lengua Castellana' que lista as expressões
 'pior apeiro' e 'faca mal-forjada'."
...
<figure class="top">
  <img alt="Cabeçalho da capa do 'Refranes', de 1555."
   src="/assets/img/2020-08-03/refranes-1.png">
</figure>

<figure class="bottom side left">
  <img alt="Trecho do 'Refranes' que lista a variante 'faca mal-forjada'."
   src="/assets/img/2020-08-03/refranes-2.png">
  <img alt="Trecho de 'Refranes' que lista a variante 'pior apeiro'."
...
Acima, temos tanto "em casa de ferreiro, pior apeiro" quanto "em casa de
ferreiro, faca mal-forjada", em um livro publicado quase 500 anos atrás
(465 anos, na data de escrita desse artigo<span id="dyn-t"></span>).
<script>{let diff=(new Date()).getFullYear()-1555;if(diff-465)document.getElementById("dyn-t").textContent=`; ${diff} anos hoje`}</script>
O Brasil tinha sido <em>descoberto</em> há pouco mais de 50 anos: uma ou duas
gerações, somente. E é uma expressão que, apesar de um pouco modificada, existe
ainda hoje! Incrível!

Mas a felicidade não para por aí: encontrei uma frase que é significantemente
parecida com o ditado, e que eu gostaria de acreditar que talvez tenha sido,
senão a origem, pelo menos uma catalisadora da popularidade do provérbio.

A frase vem de um dos muitos livros de <a
href="https://pt.wikipedia.org/wiki/Francisco_de_Osuna">Francisco de Osuna</a>,
"<i lang="es"><a href="https://books.google.com.br/books?id=1ANRAAAAcAAJ">Norte
de los estados</a></i>" (<a
href="https://pt.wikipedia.org/wiki/Sevilha">Sevilha</a>, 1531).

Importante notar que, apesar do livro ser citado por outros como tendo sido
publicado originalmente em 1531, só encontrei versões digitalizadas de 1550 e
1541 (respectivamente abaixo).

<figure class="">
  <img alt="Capa do 'Norte de los estados' (edição de 1550)."
...
<blockquote>
  <p>
    [...] <i lang="es">en casa del herrero falta las mas vezes cuchillo <b>:</b>
    y los porteros que tiene las llaves del castillo <b>:</b> entran menos vezes
    a los palacios que estan dentro</i> [...]
  </p>
  —<cite>Francisco de Osuna (1531)</cite>
</blockquote>
<blockquote>
  <p>
    <strong>Na casa do ferreiro a faca muitas vezes está faltando</strong>; e os
    porteiros que têm as chaves do castelo; entram menos vezes nos palácios que
    estão dentro
  </p>
</blockquote>

<figure class="side left">
  <img alt="Trecho do 'Norte de los estados' (1550) com a frase descrita acima."
   src="/assets/img/2020-08-03/norte-de-los-estados-2-1.png">
  <img alt="Trecho do 'Norte de los estados' (1541) com a frase descrita acima."
   src="/assets/img/2020-08-03/norte-de-los-estados-2-2.png">
  <figcaption>
    <em>
      Cima: "Norte de los estados", (<a
href="https://books.google.com.br/books?id=1ANRAAAAcAAJ&pg=PP124">1550</a>);<br>
      Baixo: "Norte de los estados", (<a
...
<figure>
  <img alt="Scan de trecho do livro de Joaquim Affonso Gonçalves, de 1829."
...
<figure class="top">
  <img alt="Cabeçalho da capa do 'Dictionary of the Portuguese and English', de
 1773."
...
<figure class="bottom side">
  <img alt="Trecho do 'Dictionary of the Portuguese and English' que lista a
 variante 'pior apeiro', além de suas equivalências em inglês."
...
Deixando de lado as analogias com sapateiros por um momento, achei interessante
...
<figure class="top">
  <img alt="Cabeçalho da capa do 'A New Dictionary, Spanish and English', de
 1726."
...
<figure class="bottom side">
  <img alt="Trecho do 'A New Dictionary, Spanish and English' que lista, em
 espanhol, as variantes 'pior apeiro' e 'faca mal-forjada', além de suas
